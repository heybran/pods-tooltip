...
export default class PodsTooltip extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div part="wrapper" class="tooltip-wrapper">
        <button 
          ...
          onclick="this.getRootNode().host.closeTooltipWhenOpen()"
  ...
  openTooltip() {
    ...
    this.tooltipContent?.addEventListener('transitionend', () => {
      if (!this.tooltipContent?.classList.contains('visible')) return;
      this.ariaExpanded = 'true';
    });
  }

  closeTooltipWhenOpen(e) {
  ...
  static get css() {
    return `
      ...
      .tooltip-button:focus-visible + .tooltip-content {
        opacity: 1;
